...
public class CardDeliverySelenidTest {
    ...
    public void ShouldCardDelivery() {
        $x(".//span[@data-test-id='city']//input").setValue("Воронеж");
        $("[data-test-id='date'] input").sendKeys(Keys.chord(Keys.SHIFT,Keys.HOME),Keys.BACK_SPACE);
        $("[data-test-id='date'] input").setValue(planningDate);
        $x(".//span[@data-test-id='name']//input").setValue("Николаев Николай");
        $x(".//span[@data-test-id='phone']//input").setValue("+71234567891");
